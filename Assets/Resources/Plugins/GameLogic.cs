...
namespace MainLogic
{
    public class GameLogic : MonoBehaviour
    {
        ...
        {
            List<Character> _charactersList = JsonConvert.DeserializeObject<List<Character>>(unitsObjectList);
            ...
            if (playerMove != null && playerMove.Length > 0)
            {
                ...
                UpdateCharacterStats(_charactersList, _heroPosition, _enemyPosition, _heroBoostStats, _enemyBoostStats);
            }

            return JsonConvert.SerializeObject(_charactersList);
        }
